...
browser.getCapabilities().then(function(thisCapabilities) {
    ...
    for (var i = 0; i < variableNames.length; ++i) {
        ...
        debug(`replace ${variableName} with ${capabilities[variableName]}`)
        capabilityStringWithoutVersion = capabilityStringWithoutVersion.replace('{' + variableName + '}', capabilities[variableName])
    }
